 ...
 * @author nizam
 */
public class RecentTransaction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RecentTransaction</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            if ((b1.equals("bacc") || b1.equals("")) && c1.equals("all")) {
                al = a.recentAccAllTransaction(a1);
            } else if ((b1.equals("bacc") || b1.equals("")) && c1.equals("cre")) {
                al = a.recentCreditTransaction(a1);
            } else if ((a1.equals("acc") || a1.equals("")) && (b1.equals("bacc") || b1.equals("")) && c1.equals("deb")) {
                al = a.recentDebitTransaction();
            } else if ((b1.equals("bacc") || b1.equals("")) && c1.equals("tnf")) {
                al = a.recentTransferTransaction(a1);
            ...
            out.println("<form action='RecentTransaction'><input type='text' name='a1' placeholder='Account number' value='" + a1 + "' readonly><input type='text' name='b1' value='" + b1 + "' placeholder='Beneficiary Account number'><select id='c1' name='c1'><option value='all'>all</option><option value='tnf'>transfer</option><option value='cre'>credit</option><option value='deb'>debit</option></select><input type='submit' name='submit'></form>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RecentTransaction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
